...
def main():
    ...
    def tiempo():
        global counting_time, counting_string
        ...
        text1 = font.render("Time: " + str(counting_string), True, (0, 0, 0))
        text1Rect = text1.get_rect()
        text1Rect.center = (1000, 70)
...
def menu(lifes):
    ...
    while run:
        ...
        if lifes > 0:
            ...
            time = font.render("Your time: " + str(counting_string), True, (0, 0, 0))
            timeRect = time.get_rect()
            timeRect.center = (SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 + 100)
